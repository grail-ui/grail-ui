...
<ul use:useAccordion class="max-w-sm w-full rounded-lg bg-slate-100 divide-y divide-gray-300">
  <li {...$itemAttrs('item-1')} class="relative">
    <button {...$triggerAttrs('item-1')} class="font-medium text-md py-2 px-5 w-full text-left">Accessibility</button>
  ...
  <li {...$itemAttrs('item-2')} class="relative">
    <h3>
      <button {...$triggerAttrs('item-2')} class="font-medium text-md py-2 px-5 w-full text-left">Flexibility</button>
    </h3>
  ...
  <li {...$itemAttrs('item-3')} class="relative">
    <h3>
      <button {...$triggerAttrs('item-3')} class="font-medium text-md py-2 px-5 w-full text-left">Animations</button>
    </h3>
