<script lang="ts">
	import type { NumberInputReturn } from '../numberInput.types';

	export let api: NumberInputReturn;

	const { useNumberInput, labelAttrs, inputAttrs, incrementAttrs, decrementAttrs } = api;
</script>
